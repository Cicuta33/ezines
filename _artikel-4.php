<article class="layout-3 color-4">
	<div>
		<header>
			<figure class="full">
					<img src="images/magazine-1/cover.jpg" alt=""/>
				
				
			</figure>
			<h1>Successvolle ondernemers&shy;campagne</h1>
			<h2>Het bruis-team van de EVD en de moderatoren van SenterNovem</h2>
		</header>
